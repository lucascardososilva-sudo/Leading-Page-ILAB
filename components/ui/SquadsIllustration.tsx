...
import { SquadsIllustrationMobile } from './SquadsIllustrationMobile';
...
export const SquadsIllustration: React.FC = () => {
  ...
  if (isMobile) {
    return <SquadsIllustrationMobile />;
  }

  return (
    <div className="w-full h-[350px] md:h-[450px] bg-white rounded-3xl overflow-hidden shadow-lg border border-gray-100 mb-8 relative">
